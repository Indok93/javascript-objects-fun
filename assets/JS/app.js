...
/* const employeesOver30 = myEmployees.filter((x)=>{
     return x.alder > 30;
}); */

const employeesOver30 = myEmployees.filter(employee => employee.alder > 30);
console.table(employeesOver30);


//Opgave 2: brug javascript til at oprette en ny array med alle ansatte under 20 år  log resultatet til konsollen som table
const employeesUnder20 = myEmployees.filter(employee => employee.alder <= 20);
console.table(employeesUnder20);
...
const employeesFemales = myEmployees.filter(employee => employee.køn === 'Kvinde' && employee.alder > 30);
console.table(employeesFemales);
...
const employeesNonBinary = myEmployees.filter(employee => employee.køn === 'Ikke-binær' && employee.alder > 20);
console.table(employeesNonBinary);